...
const translations = {
  sr: {
    ...
    'dashboard.itemsFound': '{count} pronađenih stavki',
    'dashboard.loadMore': 'Učitaj još',
    'dashboard.loading': 'Učitavanje...',
    'dashboard.error': 'Nije moguće učitati kolekciju. {message}',
    'dashboard.empty': 'Nijedna stavka ne odgovara ovim filterima.',
  ...
  en: {
    ...
    'view.grid': 'Grid view',
    'view.list': 'List view',
    'dashboard.itemsFound': '{count} Items Found',
    'dashboard.loadMore': 'Load More',
    'dashboard.loading': 'Loading...',
    'dashboard.error': "Couldn't load your collection. {message}",
    'dashboard.empty': 'No items match these filters.',
