...
**Other feature modules**: `src/features/search/` (global search dialog + panel, recent searches), `src/features/auth/RequireAuth.tsx` (route guard consuming `useAuth`/`AuthProvider`).
